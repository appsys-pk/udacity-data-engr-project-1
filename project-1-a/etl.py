...
def process_song_file(cur, filepath):
    """
    Description: This function is responsible process song json file,
    and then load extract data to database.
...
def process_log_file(cur, filepath):
    """
    Description: This function is responsible process log data json file,
    and then load extract data to database.
    ...
    for index, row in df.iterrows():
        ...
        songplay_data = (time_df.timestamp[index], row.userId, row.level, songid, artistid, 
...
def main():
    """
    Description: This function is responsible to process songs and user log file,
    and then load extract data to database.
